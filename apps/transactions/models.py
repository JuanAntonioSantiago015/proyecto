...
class DetalleTransaccion(models.Model):
    transaction_id = models.ForeignKey(HistorialTransaccion, blank=False, null=False, on_delete=models.CASCADE)
    medicine_id = models.ForeignKey(Medicamento, null=False, blank=False, on_delete=models.CASCADE)
